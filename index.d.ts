...
interface BlogFilter {
  (
    event: "post.create",
    handler: (
      data: FilterPostCreateData,
    ) => FilterPostCreateData | null | undefined,
  ): void;
  (
    event: "post.update",
    handler: (
      data: FilterPostUpdateData,
    ) => FilterPostUpdateData | null | undefined,
  ): void;
  (
    event: "comment.create",
    handler: (
      data: FilterCommentCreateData,
    ) => FilterCommentCreateData | null | undefined,
  ): void;
  (
    event: "user.register",
    handler: (
      data: FilterUserRegisterData,
    ) => FilterUserRegisterData | null | undefined,
  ): void;
  (
    event: "user.update",
    handler: (
      data: FilterUserUpdateData,
    ) => FilterUserUpdateData | null | undefined,
  ): void;
  (
    event: "media.upload",
    handler: (
      data: FilterMediaUploadData,
    ) => FilterMediaUploadData | null | undefined,
  ): void;
  (
    event: "content.render",
    handler: (
      data: FilterContentRenderData,
    ) => FilterContentRenderData | null | undefined,
  ): void;
