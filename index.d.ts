...
interface BlogOn {
  ...
  (
    ...
    handler: (payload: PostPublishedPayload) => void,
  ): void;
  ...
  (
    ...
    handler: (payload: CommentCreatedPayload) => void,
  ): void;
  (
  ...
  (
    ...
    handler: (payload: CommentStatusChangedPayload) => void,
  ): void;
  (
    event: "comment.approved",
    handler: (payload: CommentApprovedPayload) => void,
  ): void;
  // User
  (
    event: "user.registered",
    handler: (payload: UserRegisteredPayload) => void,
  ): void;
  ...
  (
    event: "user.followed",
    handler: (payload: UserFollowedPayload) => void,
  ): void;
  ...
  (
    ...
    handler: (payload: MediaUploadedPayload) => void,
  ): void;
  (
    event: "media.deleted",
    handler: (payload: MediaDeletedPayload) => void,
  ): void;
  // Taxonomy / Term
  (
    event: "taxonomy.created",
    handler: (payload: TaxonomyCreatedPayload) => void,
  ): void;
  (
    event: "taxonomy.deleted",
    handler: (payload: TaxonomyDeletedPayload) => void,
  ): void;
  ...
  (
    ...
    handler: (payload: ReactionPayload) => void,
  ): void;
  (event: "checkin.done", handler: (payload: CheckinPayload) => void): void;
  // System
  (
    event: "option.updated",
    handler: (payload: OptionUpdatedPayload) => void,
  ): void;
  (
    event: "plugin.installed",
    handler: (payload: PluginInstalledPayload) => void,
  ): void;
  (
    event: "plugin.uninstalled",
    handler: (payload: PluginUninstalledPayload) => void,
  ): void;
...
interface BlogFilter {
  (
    event: "post.create",
    handler: (ctx: PluginCtx<FilterPostCreateData>) => void,
  ): void;
  (
    event: "post.update",
    handler: (ctx: PluginCtx<FilterPostUpdateData>) => void,
  ): void;
  (
    event: "post.delete",
    handler: (ctx: PluginCtx<FilterPostDeleteData>) => void,
  ): void;
  (
    event: "comment.create",
    handler: (ctx: PluginCtx<FilterCommentCreateData>) => void,
  ): void;
  (
    event: "comment.delete",
    handler: (ctx: PluginCtx<FilterCommentDeleteData>) => void,
  ): void;
  (
    event: "term.create",
    handler: (ctx: PluginCtx<FilterTermCreateData>) => void,
  ): void;
  (
    event: "user.register",
    handler: (ctx: PluginCtx<FilterUserRegisterData>) => void,
  ): void;
  (
    event: "user.update",
    handler: (ctx: PluginCtx<FilterUserUpdateData>) => void,
  ): void;
  (
    event: "media.upload",
    handler: (ctx: PluginCtx<FilterMediaUploadData>) => void,
  ): void;
  (
    event: "content.render",
    handler: (ctx: PluginCtx<FilterContentRenderData>) => void,
  ): void;
